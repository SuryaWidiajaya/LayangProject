...
export default function Contact() {
  return (
    <div className='flex'>
        <div className="w-[516px] h-[735px] pt-[96px] pl-[156px] pr-[96px] " style={{backgroundImage: `url(${BgContact})`}}>
            ...
            <div className="w-[648px]">
                ...
                <div className="flex gap-[24px] mb-[24px]">
                    <div className="">
                        ...
                        <input className='border border-1 border-gray-300 flex rounded-[8px] w-[312px] h-[52px] bg-white ' type="text" />
                    </div>
                    <div className="">
                        <label className='text-[#27005D] text-[14px] font-bold pb-[10px]'>Email</label>
                        <input className='border border-1 border-gray-300 flex rounded-[8px] w-[312px] h-[52px] bg-white'  />
                    </div>
                </div>
                ...
                <div className="mb-[48px]">
                    ...
                    <input className='border border-1 border-gray-300 flex rounded-[8px] w-[648px] h-[153px] bg-white' placeholder='ketik disini' />
                </div>
