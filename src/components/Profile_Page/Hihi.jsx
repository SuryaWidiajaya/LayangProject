    ...
    <div>
      <div className="container flex mt-[70px]">
        <div className="containerLeft font-Poppins w-[652px] ml-[200px]">
          ...
          <p className="text-slate-950 text-[18PX] mt-[40px] font-normal">
          ...
          <p className="text-slate-950 text-[18PX] mt-[20px] font-normal">
          ...
          <p className="text-slate-950 text-[18PX] mt-[26px] font-normal">
        ...
        <div className="containerRight h-[456px] w-[456px]  ml-[107px] z-0 ">
          <img src="/imgProfile/profile.png" alt="" />
        </div>
      </div>
    </div>
  );
