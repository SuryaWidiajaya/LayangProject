...
export default function Footer() {
  return (
    <>
      <div className='bg-[#27005D] rounded-t-[30px] w-screen'>
        <div className="container font-Poppins pt-[100px] rounded-t-[30px] mt-[-25px]" >
          <div className='pr-64'>
            ...
            <p className="text-white opacity-30 w-[360px] my-[24px] ml-[156px]">Jln. Panji Tilar no. 13, Karang Anyar, Lombok Utara, Nusa Tenggara Barat</p>
          </div>
          ...
          <div className="produk-kami  grid justify-center -mt-[170px] ml-[-300px]">
