    ...
    return (
        <>
            <div className="Article font-Poppins gap-[12px] text-center mt-[50px] mb-[100px]">
                <h1 className="text-[#27005D] text-[44px] font-bold" data-aos="fade-up" data-aos-delay='0'>Semua Informasi di Desa Anda</h1>
                <p className="text-[18px] opacity-50" data-aos="fade-up" data-aos-delay='200'>Baca informasi informasi penting di desa anda yang dikelola langsung oleh <br /> warga setempat</p>
            </div>
            <div className="flex gap-[38px] font-Poppins ml-[200px]" data-aos="fade-up" data-aos-delay='400'>
                ...
                <div className="lainnya ml-[66px] " data-aos="fade-up" data-aos-delay='600'>
                   ...
                   <Link href='./NewsList'><ButtonArticle /></Link> 
                </div>
            </div>
        </>
    );
