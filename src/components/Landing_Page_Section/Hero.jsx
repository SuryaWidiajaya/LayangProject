...
export default function Hero(){
    ...
    return(
        <>
        <div className="container py-[96px] px-[200px] font-Poppins">
            <span className='text-[#444BD3] font-semibold text-[16px]' data-aos="fade-up" data-aos-delay='0'>MENGAPA HARUS LAYANG?</span>
