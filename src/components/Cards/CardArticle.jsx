            ...
            <div className=" ">
                ...
                <div className="textArticle font-Poppins gap-[14px] pb-[38px] px-[32px] ">
                    ...
                    <div className='mt-[14px]'>
                        <Link href={"/Article/" + id} className='mx-auto'>
                            <ButtonArticle />
                        </Link>
                    </div>
                </div>
