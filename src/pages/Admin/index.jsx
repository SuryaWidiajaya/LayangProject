        ...
        <>
            <div className='fixed w-screen h-screen flex'>
                    ...
                    <div className="bg-[#27005D] w-64 pb-4 rounded-r-3xl border-r-4 border-white h-screen">
                        ...
                        <nav className="mb-8 pb-8 font-Poppins md:pt-16 lg:pt-16">
                            <ul className="rounded-r-full py-4 pl-16 ml-auto">
                                <li
                                    className={activeTab === 'article' ? 'mb-1 bg-white hover:bg-gray-300 cursor-pointer rounded-tl-xl py-2' : 'mb-1 bg-white hover:bg-gray-300 cursor-pointer py-2'}
                ...
                <div className='flex flex-col flex-grow'>
                    ...
                    <div className='ml-64 pl-1 pr-6 pt-6 pb-3 z-0 overflow-y-auto max-h-screen'>
                        {renderContent()}
                    </div>
                </div>
            </div>
