        ...
        <div className="w-3/4 mt-10">
          <form onSubmit={updateAdmin} className="bg-white  px-8 pt-6 pb-8 mb-4 rounded-[30px] border-[1px] border-[#D9D9D9] hover:border-transparent hover:shadow-lg transition-all duration-300">
            ...
            <div className="mb-4">
              ...
              <select value={ProvinsiId} onChange={handleProvinsiChange} className="rounded-[10px] border-[1px] border-[#D9D9D9] w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            ...
            <div className="mb-4">
              ...
              <select value={KabupatenId} onChange={handleKabupatenChange} className="rounded-[10px] border-[1px] border-[#D9D9D9] w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
